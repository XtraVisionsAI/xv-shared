...
const startDrag = function (bar: any, target: any, callback?: any) {
  ...
  document.onmousemove = function (event) {
    ...
    if (params.flag) {
      ...
      let left = Number.parseInt(params.left as any) + disX
      let top = Number.parseInt(params.top as any) + disY
      ...
      if (typeof callback == 'function') {
        callback((Number.parseInt(params.left as any) || 0) + disX, (Number.parseInt(params.top as any) || 0) + disY)
      }
